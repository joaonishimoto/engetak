    ...
    <div className="flex items-center justify-start">
      <div className="mt-5 w-full">
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="taskname" className="block text-sm font-semibold text-zinc-800">
              name
            </label>
            <input
              id="taskname"
          ...
          <div className="mb-4">
            <label htmlFor="taskpoints" className="block text-sm font-semibold text-zinc-800">
              points
            </label>
            <input
              id="taskpoints"
